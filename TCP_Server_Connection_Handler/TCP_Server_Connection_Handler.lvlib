...
<Library LVVersion="23008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		...
		<Item Name="FindMessageStart Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/FindMessageStart Msg/FindMessageStart Msg.lvclass"/>
		<Item Name="Write Connection Information Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/Write Connection Information Msg/Write Connection Information Msg.lvclass"/>
		<Item Name="SendString Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/SendString Msg/SendString Msg.lvclass"/>
		<Item Name="Write Error Logger&apos;s Enqueuer Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/Write Error Logger&apos;s Enqueuer Msg/Write Error Logger&apos;s Enqueuer Msg.lvclass"/>
		<Item Name="Write StartMarker Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/Write StartMarker Msg/Write StartMarker Msg.lvclass"/>
		<Item Name="Read Error Logger&apos;s Enqueuer Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/Read Error Logger&apos;s Enqueuer Msg/Read Error Logger&apos;s Enqueuer Msg.lvclass"/>
		<Item Name="GetMessage Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/GetMessage Msg/GetMessage Msg.lvclass"/>
		<Item Name="GetMessageLength Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/GetMessageLength Msg/GetMessageLength Msg.lvclass"/>
		<Item Name="SendMessageToCaller Msg.lvclass" Type="LVClass" URL="../TCP_Server_Connection_Handler Messages/SendMessageToCaller Msg/SendMessageToCaller Msg.lvclass"/>
